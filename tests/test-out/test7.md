...
[2. OpenAI Obligations](#seg-44)

&ensp;&nbsp;[2.1 Customer Instructions](#seg-45)

&ensp;&nbsp;[2.2 Notices to Customer](#seg-46)

&ensp;&nbsp;[2.3 Confidentiality](#seg-47)

&ensp;&nbsp;[2.4 Data Subject Requests](#seg-48)

&ensp;&nbsp;[2.5 Security](#seg-49)

&ensp;&nbsp;[2.6 Assistance to Customer](#seg-50)

&ensp;&nbsp;[2.7 Personal Data Breaches](#seg-51)

&ensp;&nbsp;[2.8 Assessing Compliance](#seg-52)

&ensp;&nbsp;[2.9 Engagement of Sub-processors](#seg-53)

&ensp;&nbsp;[2.10 Sub-processor Obligations](#seg-54)

&ensp;&nbsp;[2.11 Data Return or Deletion](#seg-55)

[3. Customer Obligations](#seg-56)

&ensp;&nbsp;[3.1 Notices and Authorizations](#seg-57)

&ensp;&nbsp;[3.2 Cooperation](#seg-58)

&ensp;&nbsp;[3.3 Configurations](#seg-59)

[4. International Data Transfers](#seg-60)

&ensp;&nbsp;[4.1 EEA and Swiss Data](#seg-61)

&ensp;&nbsp;[4.2 UK Data](#seg-62)

[5. Further Requirements](#seg-63)

&ensp;&nbsp;[5.1 U.S. Privacy Laws Obligations](#seg-65)

&ensp;&nbsp;5.2 Customer Restrictions

[6. Definitions](#seg-67)

&#8203;7. [Schedule 1 — Details of Processing](#seg-82)

&ensp;&nbsp;[7.1 Nature and Purpose](#seg-83)

&ensp;&nbsp;[7.2 Duration](#seg-85)

&ensp;&nbsp;[7.3 Categories of Customer Data](#seg-87)

&ensp;&nbsp;[7.4 Categories of Data Subjects](#seg-89)

&ensp;&nbsp;[7.5 Sensitive Data Transferred](#seg-91)

&ensp;&nbsp;[7.6 Frequency](#seg-94)

&ensp;&nbsp;[7.7 Transfers to Sub-Processors](#seg-97)
...
&emsp;1.1 Scope and Roles. As part of providing the Services to the Customer under the Agreement, OpenAI may Process Customer Data on behalf of Customer. OpenAI acts as a Data Processor on the Customer’s behalf, and this DPA governs such Processing.

&emsp;1.2 Details of Processing. OpenAI will only Process Customer Data for the purposes of delivering the Services to Customer pursuant to the Agreement and this DPA. Details regarding the nature, duration, as well as the types of Customer Data and categories of Data Subjects involved, are set out in [Schedule 1 (Details of Processing)](#seg-82) to this DPA. OpenAI and Customer each agree to comply with their respective obligations under Data Protection Laws in connection with the Services.
...
### <a id="seg-83"></a>1. Nature and Purpose:

The performance of the Services under the Agreement.

### <a id="seg-85"></a>2. Duration:
...
### <a id="seg-87"></a>3. Categories of Customer Data:
...
### <a id="seg-94"></a>6. Frequency:

The frequency of the transfer (e.g. whether the data is transferred on a one-off or continuous basis).

Continuous basis depending on Customer’s use of the Services

### <a id="seg-97"></a>7. Transfers to Sub-Processors:

As per [Article 2.9](#seg-53) of the DPA, Sub-Processors will Process Customer Data as necessary to perform the Services. Such Processing will be for the duration of the Agreement, unless otherwise agreed in writing.

### <a id="seg-99"></a>8. SCCs information for the transfer of UK Data under [Section 4.2](#seg-62):

&emsp;8.1 Module Two (Controller to Processor) of the SCCs apply when Customer is a Data Controller and OpenAI is processing Customer Data as a Data Processor. Module Three (Processor to Sub-Processor) of the SCCs apply when Customer is a Data Processor and OpenAI is processing Customer Data as a sub-processor.

&emsp;8.2 For each module of the SCCs, where applicable, the following applies: (i) The optional docking clause in Clause 7 does not apply; (ii) In Clause 9, Option 2 (general written authorization) applies, and the minimum time period for prior notice of sub-processor changes shall be as set forth in [Section 2.9 of the DPA](#seg-53); (iii) In Clause 11, the optional language does not apply; (iv) All square brackets in Clause 13 are hereby removed; (v) In Clause 17 (Option 1), the SCCs will be governed by the laws of England and Wales; (vi) In Clause 18(b), disputes will be resolved before the courts of England and Wales; (vii) This [Schedule 1](#seg-82) contains the information required in Annex I and Annex III of the SCCs; (viii) [Section 2.5 (Security)](#seg-49) of the DPA contains the information required in Annex II of the SCCs, (ix) the competent supervisory authority is the Information Commissioner’s Office (“ICO”).

&emsp;8.3 Data exporter(s): the Customer under the Agreement; Data importer(s): OpenAI OpCo, LLC, 1455 3rd Street, San Francisco, CA 94158, Data Protection Officer, privacy@openai.com⁠.
